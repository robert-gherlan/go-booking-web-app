...
import (
	...
	"github.com/robert-gherlan/go-booking-web-app/internal/repository"
	"github.com/robert-gherlan/go-booking-web-app/internal/repository/dbrepo"
)
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		m.App.Session.Put(r.Context(), "error", "Failed to insert the reservation in the database!")
		http.Redirect(w, r, "/", http.StatusTemporaryRedirect)
		return
	}
	...
	if err != nil {
		m.App.Session.Put(r.Context(), "error", "Failed to insert the room restriction in the database!")
		http.Redirect(w, r, "/", http.StatusTemporaryRedirect)
		return
	}
	...
	htmlMessage := fmt.Sprintf(`
		...
		Dear %s:, <br>
		This is confirmation message from %s to %s.
	`, reservation.FirstName, reservation.StartDate.Format("2006-01-02"), reservation.EndDate.Format("2006-01-02"))
	msg := models.MailData{
		To:      reservation.Email,
		From:    "me@bookings.com",
	...
	// Add reservation to the session
...
// PostLogin is the login page handler that handles authentication
...
func (m *Repository) AdminAllReservations(w http.ResponseWriter, r *http.Request) {
	...
	render.Template(w, r, "admin_all_reservations.page.tmpl", &models.TemplateData{
		Data: data,
	})
}
...
func (m *Repository) AdminNewReservations(w http.ResponseWriter, r *http.Request) {
	...
	data := make(map[string]interface{})
	data["reservations"] = reservations
	render.Template(w, r, "admin_new_reservations.page.tmpl", &models.TemplateData{
		Data: data,
	})
}
...
func (m *Repository) AdminShowReservation(w http.ResponseWriter, r *http.Request) {
	...
	render.Template(w, r, "admin_reservations_show.page.tmpl", &models.TemplateData{
		StringMap: stringMap,
		Data:      data,
		Form:      forms.New(nil),
	})
...
func (m *Repository) AdminReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	render.Template(w, r, "admin_calendar_reservations.page.tmpl", &models.TemplateData{
		StringMap: stringMap,
		Data:      data,
		IntMap:    intMap,
	})
